...
import { KiyaNavigationItem, KiyaNavigationService } from '@kiya/components/navigation';
...
{
    private readonly _defaultNavigation: KiyaNavigationItem[] = defaultNavigation;
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._kiyaNavigationService.getFlatNavigation(this._defaultNavigation);
