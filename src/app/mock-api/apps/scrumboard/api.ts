...
import { KiyaMockApiService, KiyaMockApiUtils } from '@kiya/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._kiyaMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = KiyaMockApiUtils.guid();
        ...
        this._kiyaMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = KiyaMockApiUtils.guid();
        ...
        this._kiyaMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = KiyaMockApiUtils.guid();
