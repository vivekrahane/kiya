...
export class MailboxSidebarComponent implements OnInit, OnDestroy
{
    ...
    private _filtersMenuData: KiyaNavigationItem[] = [];
    private _foldersMenuData: KiyaNavigationItem[] = [];
    private _labelsMenuData: KiyaNavigationItem[] = [];
    private _otherMenuData: KiyaNavigationItem[] = [];
    ...
    private _generateFoldersMenuLinks(): void
    {
        ...
        this.folders.forEach((folder) => {
            ...
            const menuItem: KiyaNavigationItem = {
                id   : folder.id,
                title: folder.title,
                type : 'basic',
                icon : folder.icon,
    ...
    private _updateNavigationBadge(folders: MailFolder[]): void
    {
        ...
        const mainNavigationComponent = this._kiyaNavigationService.getComponent<KiyaVerticalNavigationComponent>('mainNavigation');

        // If the main navigation component exists...
        if ( mainNavigationComponent )
        {
            const mainNavigation = mainNavigationComponent.navigation;
            const menuItem = this._kiyaNavigationService.getItem('apps.mailbox', mainNavigation);
