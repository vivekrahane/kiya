            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@kiya/navigation) Expose the width variables as css custom properties, so they can be overridden from the outside',
                        '(@kiya/drawer) Expose the width variable as a css custom property, so it can be overridden from the outside',
                        '(@kiya/masonry) Removed the unnecessary scss file'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(KiyaLoadingBar) Added the KiyaLoadingBar component, its helper service and its interceptor'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(KiyaDateRange) BREAKING: Removed the KiyaDateRange component, alternative: https://github.com/fetrarij/ngx-daterangepicker-material'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@kiya/overrides/angular-material) Fixed: Normal border color of the text field overrides the invalid and focus border colors on dark themes',
                        '(@kiya/navigation) Don\'t need to use interpolation on scss variables anymore since Tailwind doesn\'t cause any problems with them anymore'
                    ]
                }
            ]
        },
        ...
        // v13.6.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@kiya/drawer) Final opacity of the overlay is not permanent due to player being destroyed right after the animation'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@kiya/theming) Better structuring on the themes.scss file',
                        '(@kiya) Disabled Angular Material "theme" sanity check since we use "all-component-themes" without a color map',
                        '(apps/mailbox) Style improvements',
                        'Removed empty "styles" from component decorators',
                        'Decreased budget sizes since new Kiya is a lot smaller compared to the one with the old design'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@kiya/overrides) Quill editor is not styled correctly by default',
                        '(@kiya/confirmation) Dialog size cannot be updated using dialogRef\'s "updateSize" method',
            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(kiya/confirmation) Confirmation dialog colors are not optimized for the Dark mode'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(kiya/confirmation) A service to quickly configure and show confirmation dialogs'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(apps/contacts) Added confirmation to the "Delete contact" action using KiyaConfirmationService',
                        '(apps/ecommerce/inventory) Added confirmation to the "Delete product" action using KiyaConfirmationService',
                        '(apps/scrumboard) Added confirmation to the "Delete list" action using KiyaConfirmationService',
                        '(apps/tasks) Added confirmation to the "Delete task" action using KiyaConfirmationService',
                        '(ui/confirmation-dialog) Created a separate page for KiyaConfirmationService and put the example configurator in there for better visibility',
                        '(docs) Moved Kiya Components and Other Components into UI for better visibility and better categorization'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(kiya/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(kiya/navigation) Moved *ngIf directives into their own "ng-container" containers',
                        '(layouts) Hide the "kiya-fullscreen" button on smaller devices since they don\'t support fullscreen',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(kiya/drawer) Memory leak due to the animation player, thanks to Vadym Pidoplichko for coming up the issue and the solution.',
                        '(kiya/navigation) Vertical navigation blocks scroll if it\'s destroyed while in "over" mode and opened',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(kiya/fullscreen) [tooltip] & [iconTpl] inputs for customizing the trigger button',
                        '(kiya/navigation) "target" property for setting the target attribute on external links',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(kiya/navigation) First children of collapsable items don\'t have proper spacing at the top',
        ...
        // v13.0.3
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Changed',
                    list: [
                        '(kiya/autogrow) BREAKING: Removed "kiyaAutogrow" in favor of "matTextareaAutosize" since all of its problems solved, use [matTextareaAutosize] without any vertical padding on the textarea itself',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(KiyaNavigation) Added support for new "isActiveMatchOptions" for Basic navigation items; https://github.com/angular/angular/pull/40303'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(KiyaNavigation) Added a generic return type for "getComponent" method on KiyaNavigationService',
                        '(KiyaNavigation) Use the generic return type for "getComponent"',
                        '(kiya) Fixed barrel exports',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(kiya/masonry) Added a component for creating fast Masonry-like layouts'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(kiya/fullscreen) Added fullscreen toggle component'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        'This is the new major version of the Kiya and it\'s completely different from previous versions with no upgrade path',
