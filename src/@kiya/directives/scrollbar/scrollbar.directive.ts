...
import { ScrollbarGeometry, ScrollbarPosition } from '@kiya/directives/scrollbar/scrollbar.types';

/**
 * Wrapper directive for the Perfect Scrollbar: https://github.com/mdbootstrap/perfect-scrollbar
 */
@Directive({
    selector: '[kiyaScrollbar]',
    exportAs: 'kiyaScrollbar'
})
export class KiyaScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_kiyaScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() kiyaScrollbar: boolean = true;
    @Input() kiyaScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'kiyaScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.kiyaScrollbar = coerceBooleanProperty(changes.kiyaScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.kiyaScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'kiyaScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.kiyaScrollbarOptions.currentValue);
