...
import { FSDocument, FSDocumentElement } from '@kiya/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'kiya-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'kiyaFullscreen'
})
export class KiyaFullscreenComponent implements OnInit
{
