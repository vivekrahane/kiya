...
import { KiyaHighlightService } from '@kiya/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[kiya-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'kiyaHighlight'
})
export class KiyaHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _kiyaHighlightService: KiyaHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._kiyaHighlightService.highlight(this.code, this.lang));
