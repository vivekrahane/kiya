...
import { KiyaAnimationCurves, KiyaAnimationDurations } from '@kiya/animations/defaults';
...
const slideInTop = trigger('slideInTop',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${KiyaAnimationDurations.entering} ${KiyaAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const slideOutTop = trigger('slideOutTop',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${KiyaAnimationDurations.exiting} ${KiyaAnimationCurves.acceleration}`
                }
            }
        )
    ]
