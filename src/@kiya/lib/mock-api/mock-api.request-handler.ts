...
import { KiyaMockApiReplyCallback } from '@kiya/lib/mock-api/mock-api.types';

export class KiyaMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: KiyaMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: KiyaMockApiReplyCallback): void
    {
        // Store the reply
